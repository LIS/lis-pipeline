...
pipeline {
	parameters {
		...
		string(defaultValue: "build_artifacts, publish_temp_artifacts, boot_test, publish_artifacts, validation, validation_hyperv, validation_sriov_hyperv, validation_nvme_hyperv, validation_migrate_hyperv, publish_azure_vhd, validation_azure, publish_results, send_mail",
